    ...
    <form id="editar" action="../functions/actualizar_usuario_noadmin.php" method="POST">
        <div class="form-group d-flex justify-content-around">
            ...
            <div class="container">
                ...
                <span class="tt" data-toggle="tooltip" data-bs-placement="right" data-bs-html="true" data-bs-trigger="hover" title="Ingrese su segundo nombre">
        ...
        <div class="form-group d-flex justify-content-around">
            ...
            <div class="container">
                ...
                <span class="tt" data-toggle="tooltip" data-bs-placement="right" data-bs-html="true" data-bs-trigger="hover" title="Ingrese su segundo apellido">
