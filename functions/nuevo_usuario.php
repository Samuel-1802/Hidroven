...
if (isset($_POST['submit_registro'])) {
    ...
    if (isset($_SESSION['mensaje']) && isset($_SESSION['tipo_mensaje'])) {
    ...
    } else if (empty_admin($cedula, $clave, $userid, $pnombre, $papellido, $nacionalidad, $admin, $fechanac, $fechaing, $cargo, $dpto, true) !== false) {
        ...
        if ($exists == true) {
            ...
            create_user($conn, $cedula, $userid, $hash, $pnombre, $snombre, $papellido, $sapellido, $nacionalidad, $admin, $fechanac, $fechaing, $cargo, $dpto);
...
<script>
    ...
    var claveEmpty = "<?php echo empty($clave); ?>";
